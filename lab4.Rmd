...
YOUR ANSWER GOES HERE  
The code chunk option I chose is include = False, it hides the output of the code chunk from displaying
...
https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_mingjiam/blob/master/lab4_self.html  
https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_mingjiam/blob/master/lab4_self.pdf  
...
YOUR ANSWER GOES HERE  
Compared with the pdf version and html version of my rmd file, it rendered it into a md file so that github can directly display the layout just like the pdf did, however .html is displaying all the source code in html language. 
